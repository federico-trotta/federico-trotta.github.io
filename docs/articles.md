...
- **Recognized as one of the most read TDS's contributors**: I was recognized as one of the most read authors by Towards Data Science:
...
I have published articles about Python programming, statistical concepts for Data Scientists, and Machine Learning.
...
:::{important}
“The 20 best LLMs for coding (+ free workflow templates) has ranked in the first page in Google.
:::

```{figure} images/articles/best_llms_for_coding.png
:alt: "The 20 best LLMs for coding (+ free workflow templates)" by Federico Trotta .
:align: center

*"The 20 best LLMs for coding (+ free workflow templates)" in Google's first page*
```
...
- [Kubernetes vs Nomad vs Bacalhau: Which Orchestrator is Right for Your Data?](https://blog.bacalhau.org/p/kubernetes-vs-nomad-vs-bacalhau-which)
